...
export default function Home() {
  ...
  return (
    <main style={{backgroundColor: '#E8F4FD', color: '#0A1628', minHeight: '100vh', fontFamily: "'Georgia', serif"}}>
      ...
      `}</style>
      <header style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, height: '70px', backgroundColor: 'rgba(6,13,26,0.85)', backdropFilter: 'blur(16px)'}}>
        <div className="header-inner" style={{width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 64px'}}>
          <div style={{fontSize: '20px', fontWeight: 300, letterSpacing: '0.35em', color: '#FFFFFF'}}>Mel de Lua</div>
          ...
          <div style={{display: 'flex', alignItems: 'center', gap: '16px'}}>
            <a href="/comecar" className="nav-desktop" style={{fontSize: '11px', letterSpacing: '0.2em', fontFamily: 'sans-serif', border: '1px solid rgba(255,255,255,0.4)', color: '#FFFFFF', padding: '10px 28px', textDecoration: 'none', textTransform: 'uppercase'}}>Começar</a>
            <button className="hamburger" onClick={() => setMenuOpen(!menuOpen)} style={{display: 'flex', flexDirection: 'column', gap: '5px', background: 'none', border: 'none', cursor: 'pointer', padding: '4px'}}>
      ...
      <div className={`mobile-menu${menuOpen ? ' open' : ''}`}>
        ...
        <a href="/comecar" style={{backgroundColor: '#2E86C1', color: '#FFFFFF !important', padding: '14px 24px', textAlign: 'center', letterSpacing: '0.15em', textTransform: 'uppercase', fontSize: '13px', marginTop: '8px', border: 'none !important'}}>Começar</a>
      </div>
      <section className="hero-section" style={{backgroundColor: '#060d1a', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', position: 'relative', overflow: 'hidden', padding: '120px 48px 80px', paddingTop: 'calc(70px + 60px)'}}>
        ...
        <div style={{position: 'relative', zIndex: 10, maxWidth: '800px', width: '100%'}}>
          ...
          <div className="hero-title">
            <h1 style={{fontSize: 'clamp(44px, 8vw, 100px)', fontWeight: 400, lineHeight: 1.05, color: '#FFFFFF', letterSpacing: '-0.02em', marginBottom: '28px'}}>
              A lua de mel<br />
          ...
          <p className="hero-sub" style={{fontSize: '17px', fontWeight: 300, lineHeight: 1.85, color: 'rgba(255,255,255,0.55)', fontFamily: 'sans-serif', marginBottom: '44px', maxWidth: '480px', margin: '0 auto 44px'}}>
            Vocês contam a história. Nossa IA cria o perfil do casal. Agências competem. O destino é uma surpresa até o reveal.
          </p>
          <div className="hero-cta" style={{display: 'flex', gap: '20px', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap'}}>
            <a href="/comecar" style={{backgroundColor: '#2E86C1', color: '#FFFFFF', padding: '18px 52px', fontSize: '12px', letterSpacing: '0.2em', textDecoration: 'none', textTransform: 'uppercase', fontFamily: 'sans-serif', minWidth: '220px'}}>Começar nossa história</a>
            <a href="#como-funciona" style={{fontSize: '13px', color: 'rgba(255,255,255,0.45)', textDecoration: 'none', letterSpacing: '0.08em', fontFamily: 'sans-serif', display: 'flex', alignItems: 'center', gap: '8px'}}>Ver como funciona <span style={{color: '#F0A500', fontSize: '16px'}}>↓</span></a>
          </div>
          <p style={{fontSize: '11px', color: 'rgba(255,255,255,0.2)', marginTop: '24px', letterSpacing: '0.12em', fontFamily: 'sans-serif'}}>Gratuito para casais · Sem compromisso</p>
        </div>
      ...
      <section style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', borderBottom: '1px solid rgba(10,22,40,0.1)'}} className="numbers-grid">
        {[
          ...
          <div key={item.num} className="numbers-item" style={{padding: '52px 40px', textAlign: 'center', borderRight: i < 2 ? '1px solid rgba(10,22,40,0.1)' : 'none', backgroundColor: '#E8F4FD'}}>
      ...
      <section id="como-funciona" style={{backgroundColor: '#0A1628'}}>
        <div className="section-pad how-header" style={{padding: '80px 72px 56px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderBottom: '1px solid rgba(255,255,255,0.06)'}}>
          <div>
          ...
          <p style={{fontSize: '14px', color: 'rgba(255,255,255,0.35)', fontFamily: 'sans-serif', maxWidth: '260px', textAlign: 'right', lineHeight: 1.8, margin: 0}}>Do briefing ao reveal — cuidado por nós e pelas melhores agências do Brasil.</p>
        </div>
        <div className="how-grid" style={{display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)'}}>
          {[
            ...
            <div key={item.num} className="how-item" style={{padding: '40px 32px', borderRight: i < 3 ? '1px solid rgba(255,255,255,0.06)' : 'none'}}>
        ...
        <div style={{maxWidth: '1200px', margin: '0 auto'}}>
          <div className="godparents-grid" style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '72px', alignItems: 'center'}}>
            <div>
              ...
              <h2 style={{fontSize: 'clamp(28px, 3.5vw, 48px)', fontWeight: 400, lineHeight: 1.15, marginBottom: '24px', color: '#0A1628', letterSpacing: '-0.02em'}}>Os padrinhos fazem<br />parte da história</h2>
              <div style={{width: '36px', height: '2px', backgroundColor: '#2E86C1', marginBottom: '24px'}} />
              <p style={{fontSize: '17px', fontWeight: 300, color: '#1B3A6B', lineHeight: 1.9, marginBottom: '24px', fontFamily: 'sans-serif'}}>Vocês escolhem 1 a 3 pessoas de confiança. Elas recebem um convite especial para guardar o segredo do destino.</p>
              <p style={{fontSize: '18px', fontStyle: 'italic', color: '#0A1628', lineHeight: 1.6, borderLeft: '3px solid #F0A500', paddingLeft: '20px', margin: 0}}>"Vocês foram escolhidos para guardar o segredo."</p>
            </div>
            <div style={{backgroundColor: '#0A1628', padding: '40px', position: 'relative'}}>
              ...
              <p style={{fontSize: '16px', fontWeight: 300, fontStyle: 'italic', color: 'rgba(255,255,255,0.65)', lineHeight: 1.9, marginBottom: '24px'}}>"Eles adoram acordar cedo para ver o sol nascer. Ele sempre quis mergulhar. Ela ama vinhos e gastronomia local."</p>
      ...
      <section className="cta-section" style={{backgroundColor: '#060d1a', minHeight: '440px', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '80px 40px', position: 'relative', overflow: 'hidden'}}>
        ...
        <div style={{position: 'relative', zIndex: 10, maxWidth: '680px', width: '100%'}}>
          ...
          <h2 style={{fontSize: 'clamp(28px, 5vw, 60px)', fontWeight: 400, color: '#FFFFFF', lineHeight: 1.15, margin: '0 auto 36px', letterSpacing: '-0.02em'}}>A história de vocês merece uma viagem à altura</h2>
          <a href="/comecar" style={{backgroundColor: '#2E86C1', color: '#FFFFFF', padding: '18px 52px', fontSize: '12px', letterSpacing: '0.2em', textDecoration: 'none', textTransform: 'uppercase', display: 'inline-block', fontFamily: 'sans-serif', minWidth: '220px'}}>Começar nossa história</a>
          <p style={{fontSize: '12px', color: 'rgba(255,255,255,0.2)', marginTop: '18px', letterSpacing: '0.1em', fontFamily: 'sans-serif'}}>Completamente gratuito para casais</p>
        </div>
      </section>
      ...
      {contatoModal && (
        <div style={{position:'fixed',inset:0,backgroundColor:'rgba(0,0,0,0.85)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:200,padding:'24px'}} onClick={()=>setContatoModal(false)}>
          <div onClick={e=>e.stopPropagation()} style={{backgroundColor:'#0A1628',border:'1px solid rgba(255,255,255,0.1)',padding:'40px',maxWidth:'480px',width:'100%',position:'relative'}}>
            ...
            {!contatoEnviado ? (
              <>
                ...
                <div style={{display:'flex',flexDirection:'column',gap:'16px',marginBottom:'24px'}}>
                  <div>
                    ...
                    <input type="text" value={contatoForm.nome} onChange={e=>setContatoForm({...contatoForm,nome:e.target.value})} placeholder="Seu nome" style={{width:'100%',padding:'11px 14px',backgroundColor:'rgba(255,255,255,0.05)',border:'1px solid rgba(255,255,255,0.1)',color:'#FFFFFF',fontSize:'14px',fontFamily:'sans-serif',boxSizing:'border-box'}}/>
                  </div>
                  <div>
                    ...
                    <input type="email" value={contatoForm.email} onChange={e=>setContatoForm({...contatoForm,email:e.target.value})} placeholder="seu@email.com" style={{width:'100%',padding:'11px 14px',backgroundColor:'rgba(255,255,255,0.05)',border:'1px solid rgba(255,255,255,0.1)',color:'#FFFFFF',fontSize:'14px',fontFamily:'sans-serif',boxSizing:'border-box'}}/>
                  </div>
                  <div>
                    ...
                    <textarea value={contatoForm.mensagem} onChange={e=>setContatoForm({...contatoForm,mensagem:e.target.value})} rows={4} placeholder="Como podemos ajudar?" style={{width:'100%',padding:'11px 14px',backgroundColor:'rgba(255,255,255,0.05)',border:'1px solid rgba(255,255,255,0.1)',color:'#FFFFFF',fontSize:'14px',fontFamily:'sans-serif',boxSizing:'border-box',resize:'none'}}/>
                  </div>
                </div>
                <div style={{display:'flex',gap:'12px',alignItems:'center',flexWrap:'wrap'}}>
                  <button onClick={()=>{const msg=encodeURIComponent(`Olá! Sou ${contatoForm.nome} (${contatoForm.email}).\n\n${contatoForm.mensagem}`);window.open(`https://wa.me/5511993580581?text=${msg}`,'_blank');setContatoEnviado(true)}} style={{backgroundColor:'#25D366',color:'#FFFFFF',padding:'11px 24px',fontSize:'12px',letterSpacing:'0.15em',border:'none',fontFamily:'sans-serif',cursor:'pointer',textTransform:'uppercase'}}>💬 WhatsApp</button>
                  <a href={`mailto:kuboferreira@gmail.com?subject=Contato Mel de Lua — ${contatoForm.nome}&body=${encodeURIComponent(contatoForm.mensagem)}`} style={{backgroundColor:'rgba(46,134,193,0.15)',color:'#FFFFFF',padding:'11px 24px',fontSize:'12px',letterSpacing:'0.15em',border:'1px solid rgba(46,134,193,0.3)',fontFamily:'sans-serif',textDecoration:'none',textTransform:'uppercase'}}>✉️ E-mail</a>
                </div>
              </>
            ) : (
              <div style={{textAlign:'center',padding:'20px 0'}}>
                ...
                <button onClick={()=>{setContatoModal(false);setContatoEnviado(false);setContatoForm({nome:'',email:'',mensagem:''})}} style={{background:'none',border:'1px solid rgba(255,255,255,0.2)',color:'rgba(255,255,255,0.5)',padding:'10px 24px',fontSize:'12px',letterSpacing:'0.15em',fontFamily:'sans-serif',cursor:'pointer'}}>Fechar</button>
              </div>
            )}
          </div>
        </div>
