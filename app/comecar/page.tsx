  ...
  return (
    <main style={{
      ...
      <style>{`
        ...
        @keyframes aurora2 {
          0%   { transform: translateX(20%) translateY(10%) scale(1.1); opacity: 0.2; }
          50%  { transform: translateX(-10%) translateY(-5%) scale(0.9); opacity: 0.35; }
          100% { transform: translateX(20%) translateY(10%) scale(1.1); opacity: 0.2; }
        }
        @keyframes fadeIn {
      ...
      <div style={{position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0}}>
        <div style={{
          ...
          background: 'radial-gradient(ellipse, rgba(46,134,193,0.35) 0%, transparent 70%)',
          animation: 'aurora1 14s ease-in-out infinite', filter: 'blur(80px)',
        }} />
        <div style={{
          position: 'absolute', bottom: '-20%', right: '-15%',
          width: '70vw', height: '70vh', borderRadius: '50%',
          background: 'radial-gradient(ellipse, rgba(0,160,140,0.25) 0%, transparent 70%)',
          animation: 'aurora2 18s ease-in-out infinite', filter: 'blur(90px)',
        }} />
      </div>
      ...
      <header style={{
        ...
        backgroundColor: 'rgba(6,13,26,0.85)', backdropFilter: 'blur(16px)',
      ...
      {!started && (
        <div className="fade-up" style={{
          ...
          <p style={{
            fontSize: '17px', fontWeight: 300, color: 'rgba(255,255,255,0.45)',
            fontFamily: 'sans-serif', lineHeight: 1.8, maxWidth: '460px', marginBottom: '44px',
          }}>
            ...
            {messages.map((msg, i) => (
              <div key={i} className="msg-bubble" style={{
                ...
                <div style={{
                  ...
                  <p style={{
                    margin: 0, fontSize: '16px', lineHeight: 1.75,
            ...
            {completed && (
              <div className="msg-bubble" style={{
                ...
                <p style={{color: 'rgba(255,255,255,0.5)', fontFamily: 'sans-serif', fontSize: '14px', margin: 0}}>
                  Briefing salvo! Em breve as agências entrarão em contato.
                </p>
              </div>
            )}
            ...
            <div style={{
              ...
              <textarea
                ...
                style={{
                  ...
                  color: '#FFFFFF', fontSize: '16px', fontFamily: 'sans-serif',
              ...
              <button
                ...
                className="send-btn"
                style={{
                  backgroundColor: input.trim() && !loading && !completed ? '#2E86C1' : 'rgba(46,134,193,0.15)',
                  border: 'none', borderRadius: '8px',
                  width: '38px', height: '38px',
                  cursor: input.trim() && !loading && !completed ? 'pointer' : 'default',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
