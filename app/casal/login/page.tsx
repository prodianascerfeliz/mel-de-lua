...
export default function LoginCasal() {
      ...
      <div style={{position:'relative',zIndex:10,width:'100%',maxWidth:'420px'}}>
        <div style={{textAlign:'center',marginBottom:'40px'}}>
          ...
          <div style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'12px',marginTop:'16px'}}>
            ...
            <span style={{fontSize:'10px',letterSpacing:'0.4em',color:'#F0A500',textTransform:'uppercase',fontFamily:'sans-serif'}}>Área do casal</span>
            <div style={{width:'24px',height:'1px',backgroundColor:'#F0A500'}}/>
          </div>
        </div>

        <div style={{backgroundColor:'rgba(255,255,255,0.04)',border:'1px solid rgba(255,255,255,0.08)',padding:'40px',backdropFilter:'blur(12px)'}}>
          <h1 style={{fontSize:'24px',fontWeight:400,color:'#FFFFFF',marginBottom:'8px',letterSpacing:'-0.01em'}}>
            Bem-vindos de volta 💛
          </h1>
          <p style={{fontSize:'14px',color:'rgba(255,255,255,0.4)',fontFamily:'sans-serif',marginBottom:'32px',fontWeight:300,lineHeight:1.7}}>
            Suas propostas estão esperando por vocês.
          </p>

          <form onSubmit={handleLogin} style={{display:'flex',flexDirection:'column',gap:'20px'}}>
            <div>
              <label style={{display:'block',fontSize:'11px',letterSpacing:'0.2em',color:'rgba(255,255,255,0.5)',textTransform:'uppercase',fontFamily:'sans-serif',marginBottom:'8px'}}>E-mail</label>
              <input type="email" value={email} onChange={e=>setEmail(e.target.value)} required placeholder="seu@email.com"
                style={{width:'100%',padding:'12px 16px',backgroundColor:'rgba(255,255,255,0.05)',border:'1px solid rgba(255,255,255,0.1)',color:'#FFFFFF',fontSize:'15px',fontFamily:'sans-serif',boxSizing:'border-box',transition:'border-color 0.2s'}}/>
            </div>
            <div>
              <label style={{display:'block',fontSize:'11px',letterSpacing:'0.2em',color:'rgba(255,255,255,0.5)',textTransform:'uppercase',fontFamily:'sans-serif',marginBottom:'8px'}}>Senha</label>
            ...
            <button type="submit" disabled={loading} className="btn-login"
              style={{backgroundColor:'#2E86C1',color:'#FFFFFF',padding:'15px',fontSize:'12px',letterSpacing:'0.2em',border:'none',textTransform:'uppercase',fontFamily:'sans-serif',cursor:loading?'wait':'pointer',transition:'background-color 0.2s',marginTop:'8px'}}>
        ...
        <p style={{textAlign:'center',fontSize:'12px',color:'rgba(255,255,255,0.2)',marginTop:'24px',fontFamily:'sans-serif'}}>
          Ainda não tem conta? <a href="/comecar" style={{color:'rgba(46,134,193,0.7)',textDecoration:'none'}}>Começar briefing</a>
        </p>
      </div>
    </main>
  )
